<template>
  <div class="vue-song">
    ...
    <div class="song-wrapper">
      <audio :src="`http://ws.stream.qqmusic.qq.com/C100${song.songmid}.m4a?fromtag=0`" loop id="audio" ref="audio"></audio>
      <div class="song-info">
      ...
      <a class="download" :href="`http://ws.stream.qqmusic.qq.com/C100${song.songmid}.m4a?fromtag=0`"><i class="iconfont icon-download"></i></a>
    </div>
  </div>
</template>
